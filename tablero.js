...
function compra(){
    ...
    document.write("<center> Su dirección  es:"+ dirección+"<br>");
    document.write("<center> Su Número de DNI es:"+ codigo1+"<br>");
    document.write("<center> La forma de comprar que eligió es:"+delivery+"<br>");  
